          ...
          <div class="onboarding-modal">
            ...
            <div class="onboarding-carousel">
                ...
                >
                  ...
                  <div class="onboarding-slide">
                    ...
                    <h3 class="slide-title">
                      {{ $t("onboarding.contact_management") }}
                    </h3>
                    <p class="slide-description">
                      {{ $t("onboarding.contact_management_description") }}
                    </p>
                    <div class="slide-features">
                      <div class="feature-item">
                        <UIcon
                          ...
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.contact_list") }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          name="i-heroicons-check-circle"
                        ...
                        />
                        <span>{{
                          $t("onboarding.advanced_categorization")
                        }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          ...
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.easy_import_export") }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="onboarding-slide">
                    ...
                    <h3 class="slide-title">{{ $t("onboarding.ai_agent") }}</h3>
                    <p class="slide-description">
                      {{ $t("onboarding.ai_agent_description") }}
                    </p>
                    <div class="slide-features">
                      <div class="feature-item">
                        <UIcon
                          ...
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.smart_auto_responses") }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          name="i-heroicons-check-circle"
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.customer_support") }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          name="i-heroicons-check-circle"
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.take_over") }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="onboarding-slide">
                    ...
                    <h3 class="slide-title">
                      {{ $t("onboarding.whatsapp_marketing") }}
                    </h3>
                    <p class="slide-description">
                      {{ $t("onboarding.whatsapp_marketing_description") }}
                    </p>
                    <div class="slide-features">
                      <div class="feature-item">
                        <UIcon
                        ...
                        />
                        <span>{{
                          $t("onboarding.customized_mass_campaigns")
                        }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          ...
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.schedule_sending") }}</span>
                      </div>
                      <div class="feature-item">
                        <UIcon
                          name="i-heroicons-check-circle"
                          class="w-5 h-5"
                        />
                        <span>{{ $t("onboarding.detailed_statistics") }}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="onboarding-nav">
                ...
                <button @click="skipOnboarding" class="onboarding-btn skip-btn">
                  {{ $t("onboarding.skip") }}
                </button>
                <button
...
const slides = [
  { title: t("onboarding.contact_management"), icon: "users" },
  { title: t("onboarding.ai_agent"), icon: "cpu-chip" },
  { title: t("onboarding.whatsapp_marketing"), icon: "megaphone" },
];
