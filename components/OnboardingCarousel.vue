          ...
          <div class="onboarding-modal">
            ...
            <div class="onboarding-carousel">
                ...
                >
                  ...
                  <div class="onboarding-slide">
                    ...
                    <p class="slide-description">
                      Organisez et catégorisez efficacement tous vos contacts
                      WhatsApp. Créez des groupes personnalisés pour mieux
                      cibler vos communications.
                    </p>
                  ...
                  <div class="onboarding-slide">
                    ...
                    <p class="slide-description">
                      Automatisez vos conversations WhatsApp grâce à notre agent
                      IA intelligent. Offrez un support client 24/7 sans
                  ...
                  <div class="onboarding-slide">
                    ...
                    <p class="slide-description">
                      Envoyez des messages ciblés à grande échelle pour vos
                      campagnes marketing. Suivez les performances et optimisez
                      vos communications.
                    </p>
                    <div class="slide-features">
                      <div class="feature-item">
              ...
              <div class="onboarding-nav">
                ...
                >
                  {{ isCompleting ? "Parfait !" : "Commencer" }}
                  <UIcon
                    :name="
                      isCompleting
...
const triggerConfetti = () => {
  ...
  }, 4000); // Arrête l'effet après 3 secondes
};
...
const completeOnboarding = () => {
  if (isCompleting.value) return; // Évite les doubles clics

  isCompleting.value = true; // Indique que l'onboarding est en cours de finalisation
  triggerConfetti(); // Déclenche l'effet de confettis pour la complétion

  // Attend 2.5 secondes pour que l'utilisateur puisse voir les confettis
  setTimeout(() => {
    markOnboardingAsDone(); // PUIS ferme le modal
